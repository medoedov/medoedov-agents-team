...
Launch `code-researcher` subagent (spawn_agent tool, opus) with feature path and feature description
from Cycle 1.
...
Launch `userspec-validator` subagent (spawn_agent tool) with feature path. It reviews
