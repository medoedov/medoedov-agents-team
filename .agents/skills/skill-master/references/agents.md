...
The orchestrator calls spawn_agent tool with arbitrary prompt and `task_name`. No agent file needed.
...
| `skills` | Load Codex skill: s to preload — agent must have methodology from skill |
