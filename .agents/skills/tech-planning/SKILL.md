...
<!-- Generated by sync_to_codex.py. Do not edit directly. Source: .claude\skills\tech-planning\SKILL.md. -->
...
Launch `code-researcher` subagent (spawn_agent tool, opus) with feature path and user-spec path. The agent reads existing `code-research.md` (from user-spec phase if available) and deepens analysis for implementation.
