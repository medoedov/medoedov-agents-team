...
Run `documentation-reviewer` agent (spawn_agent tool, sonnet) on the project. Fix critical and major findings. Minor findings — fix or leave at your discretion.
