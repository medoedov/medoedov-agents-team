...
description: |
  Codex adapter for the Claude `/done` command. Finalize a completed feature: read specs and decisions, update project knowledge files,
  Use when the user invokes that command or asks for the equivalent workflow.
---

<!-- Generated by sync_to_codex.py. Do not edit directly. Source: .claude/commands/done.md. -->
