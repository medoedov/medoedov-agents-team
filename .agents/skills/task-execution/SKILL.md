...
<!-- Generated by sync_to_codex.py. Do not edit directly. Source: .claude\skills\task-execution\SKILL.md. -->
...
| `teammate_name` | Agent name used for send_message routing (optional). |
